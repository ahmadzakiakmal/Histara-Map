            ...
            <img
              src={
                process.env.NEXT_PUBLIC_ENV === "DEV"
                  ? "http://localhost:3000/images/MG02-" + (item.properties.index < 10 ? "0" : "") + item.properties.index + ".png"
                  : "https://histara-map.vercel.app/images/MG02-" + (item.properties.index < 10 ? "0" : "") + item.properties.index + ".png"
              }
...
export default dynamic(() => Promise.resolve(MG02), {
  ssr: false,
});
