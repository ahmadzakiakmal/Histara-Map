            ...
            <img 
              ...
              src={
                process.env.NEXT_PUBLIC_ENV === "DEV"
                  ? "http://localhost:3000/images/YG03-" + (item.properties.index < 10 ? "0" : "") + item.properties.index + ".png"
                  : "https://histara-map.vercel.app/images/YG03-" + (item.properties.index < 10 ? "0" : "") + item.properties.index + ".png"
              }
...
export default dynamic(() => Promise.resolve(YG03), {
  ssr: false,
});
